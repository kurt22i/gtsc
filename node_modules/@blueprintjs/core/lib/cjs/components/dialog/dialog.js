...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.maybeRenderHeader = function () {
        ...
        return (React.createElement("div", { className: common_1.Classes.DIALOG_HEADER },
            React.createElement(icon_1.Icon, { icon: icon, size: icon_1.IconSize.LARGE, "aria-hidden": true, tabIndex: -1 }),
            React.createElement(html_1.H4, { id: this.titleId }, title),
    ...
    Dialog.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".Dialog");
    return Dialog;
