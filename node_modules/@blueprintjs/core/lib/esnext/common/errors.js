...
export const HOTKEYS_TARGET2_CHILDREN_LOCAL_HOTKEYS = ns +
...
export const PANEL_STACK_INITIAL_PANEL_STACK_MUTEX = ns + ` <PanelStack> requires exactly one of initialPanel and stack prop`;
