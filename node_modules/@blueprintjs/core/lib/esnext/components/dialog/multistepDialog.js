...
const MIN_WIDTH = 800;
export class MultistepDialog extends AbstractPureComponent2 {
    ...
    render() {
        ...
        return (React.createElement(Dialog, { isCloseButtonShown: isCloseButtonVisible, ...otherProps, style: this.getDialogStyle() },
    ...
    renderFooter() {
        ...
        const maybeCloseButton = !isFooterCloseButtonVisible ? undefined : (React.createElement(Button, { text: "Close", onClick: onClose, ...closeButtonProps }));
    ...
    renderButtons() {
        ...
        if (this.state.selectedIndex > 0) {
            ...
            buttons.push(React.createElement(Button, { key: "back", onClick: this.getDialogStepChangeHandler(selectedIndex - 1), text: "Back", ...backButtonProps }));
        }
        if (selectedIndex === this.getDialogStepChildren().length - 1) {
            buttons.push(React.createElement(Button, { intent: "primary", key: "final", text: "Submit", ...this.props.finalButtonProps }));
        }
        else {
            const nextButtonProps = steps[selectedIndex].props.nextButtonProps ?? this.props.nextButtonProps;
            buttons.push(React.createElement(Button, { intent: "primary", key: "next", onClick: this.getDialogStepChangeHandler(selectedIndex + 1), text: "Next", ...nextButtonProps }));
        }
        return buttons;
    }
