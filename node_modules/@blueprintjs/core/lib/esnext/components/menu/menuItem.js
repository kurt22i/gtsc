...
export class MenuItem extends AbstractPureComponent2 {
    ...
    render() {
        ...
        active, className, children, disabled, icon, intent, labelClassName, labelElement, multiline, popoverProps, selected, shouldDismissPopover, text, textClassName, tagName = "a", htmlTitle, ...htmlProps } = this.props;
