...
exports.ContextMenu2 = React.forwardRef(function (props, userRef) {
    var _a;
    var _b;
    var className = props.className, children = props.children, content = props.content, _c = props.disabled, disabled = _c === void 0 ? false : _c, onContextMenu = props.onContextMenu, popoverProps = props.popoverProps, _d = props.tagName, tagName = _d === void 0 ? "div" : _d, restProps = tslib_1.__rest(props, ["className", "children", "content", "disabled", "onContextMenu", "popoverProps", "tagName"]);
    ...
    var _e = React.useContext(tooltip2Context_1.Tooltip2Context), tooltipCtxDispatch = _e[1];
    ...
    var handleContextMenu = React.useCallback(function (e) {
        ...
        var shouldHandleEvent = !disabled && (core_1.Utils.isFunction(children) || maybePopover !== undefined);
