...
var Popover2 = /** @class */ (function (_super) {
    ...
    function Popover2() {
        ...
        _this.renderTarget = function (_a) {
            ...
            var targetProps = tslib_1.__assign({ "aria-haspopup": "true", 
                ...
                className: (0, classnames_1.default)(className, Classes.POPOVER2_TARGET, (_b = {},
                    ...
                    _b[core_1.Classes.ACTIVE] = !isControlled && isOpen && !isHoverInteractionKind,
                    _b)), ref: ref }, targetEventHandlers);
            var target;
            if (renderTarget !== undefined) {
                target = renderTarget(tslib_1.__assign(tslib_1.__assign({}, targetProps), { 
