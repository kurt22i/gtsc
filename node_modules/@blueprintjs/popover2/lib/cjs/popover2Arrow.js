...
exports.Popover2Arrow = exports.TOOLTIP_ARROW_SVG_SIZE = exports.POPOVER_ARROW_SVG_SIZE = void 0;
...
function getArrowAngle(placement) {
    ...
    switch ((0, utils_1.getBasePlacement)(placement)) {
        case "top":
            return -90;
        case "left":
            return 180;
...
function getArrowReferenceOffsetStyle(placement) {
    var offset = exports.POPOVER_ARROW_SVG_SIZE / 2 - ARROW_SPACING;
    switch ((0, utils_1.getBasePlacement)(placement)) {
        case "top":
...
var Popover2Arrow = function (_a) {
    ...
    React.createElement("div", { className: Classes.POPOVER2_ARROW, "data-popper-arrow": true, ref: ref, style: tslib_1.__assign(tslib_1.__assign({}, style), getArrowReferenceOffsetStyle(placement)) },
        React.createElement("svg", { viewBox: "0 0 ".concat(exports.POPOVER_ARROW_SVG_SIZE, " ").concat(exports.POPOVER_ARROW_SVG_SIZE), style: { transform: "rotate(".concat(getArrowAngle(placement), "deg)") } },
...
exports.Popover2Arrow = Popover2Arrow;
exports.Popover2Arrow.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".Popover2Arrow");
