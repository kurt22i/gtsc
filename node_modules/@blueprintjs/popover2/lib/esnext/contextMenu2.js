...
export const ContextMenu2 = React.forwardRef((props, userRef) => {
    ...
    const maybePopover = menu === undefined ? undefined : (React.createElement(Popover2, { ...popoverProps, content: 
        ...
        }), placement: "right-start", positioningStrategy: "fixed", rootBoundary: "viewport", renderTarget: renderTarget, transitionDuration: popoverProps?.transitionDuration ?? 100 }));
