 ...
 */
export class Popover2 extends AbstractPureComponent2 {
    static displayName = `${DISPLAYNAME_PREFIX}.Popover2`;
    static defaultProps = {
    ...
    /** Target ref handler */
    targetRef = el => (this.targetElement = el);
    cancelOpenTimeout;
    ...
    isHoverInteractionKind = () => {
        return (this.props.interactionKind === Popover2InteractionKind.HOVER ||
    ...
    renderTarget = ({ ref: popperChildRef }) => {
        ...
        return (React.createElement(ResizeSensor2, { targetRef: ref, onResize: this.reposition }, target));
    };
    renderPopover = (popperProps) => {
        ...
        const popoverClasses = classNames(Classes.POPOVER2, {
        ...
        return (React.createElement(Overlay, { autoFocus: this.props.autoFocus ?? defaultAutoFocus, backdropClassName: Classes.POPOVER2_BACKDROP, backdropProps: this.props.backdropProps, canEscapeKeyClose: this.props.canEscapeKeyClose, canOutsideClickClose: this.props.interactionKind === Popover2InteractionKind.CLICK, enforceFocus: this.props.enforceFocus, hasBackdrop: this.props.hasBackdrop, isOpen: isOpen, onClose: this.handleOverlayClose, onClosed: this.props.onClosed, onClosing: this.props.onClosing, onOpened: this.props.onOpened, onOpening: this.props.onOpening, transitionDuration: this.props.transitionDuration, transitionName: Classes.POPOVER2, usePortal: this.props.usePortal, portalClassName: this.props.portalClassName, portalContainer: this.props.portalContainer, 
            ...
            React.createElement("div", { className: Classes.POPOVER2_TRANSITION_CONTAINER, ref: popperProps.ref, style: popperProps.style },
                React.createElement(ResizeSensor2, { onResize: this.reposition },
                    React.createElement("div", { className: popoverClasses, style: { transformOrigin }, ref: this.popoverRef, ...popoverHandlers },
                        this.isArrowEnabled() && (React.createElement(Popover2Arrow, { arrowProps: popperProps.arrowProps, placement: popperProps.placement })),
                        React.createElement("div", { className: Classes.POPOVER2_CONTENT }, this.props.content))))));
    };
    getPopperModifiers() {
    ...
    updateDarkParent() {
        if (this.props.usePortal && this.state.isOpen) {
            const hasDarkParent = this.targetElement != null && this.targetElement.closest(`.${CoreClasses.DARK}`) != null;
