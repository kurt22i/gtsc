...
export declare type StrictModifierNames = NonNullable<StrictModifiers["name"]>;
export declare type Popover2TargetProps = IPopover2TargetProps;
/**
...
export declare type Popover2SharedProps<T> = IPopover2SharedProps<T>;
/**
